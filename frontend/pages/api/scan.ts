...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    return res.status(200).json({ success: true, scan_id: `scan_${Date.now()}`, count: 10, trends: getMockTrends() })
  }
}
...
function getMockTrends() {
  return [
    ...
    { name: "Shilajit", score: 81, classification: "Strong Trend", marketOpportunity: "$180M by 2027", productConcept: "Shilajit + Ashwagandha men's vitality stack", packagingFormat: "Resin jar + dropper (40g)", launchTiming: "Q3 2025", opportunityBrief: "Shilajit is experiencing a breakout moment in India driven by growing male wellness awareness and Ayurvedic ingredient revival. YouTube search volume has tripled YoY.", signals: { velocity: 92, marketPotential: 65, scientificBacking: 64, consumerBuzz: 88, competition: 55 } },
    { name: "Lion's Mane Mushroom", score: 78, classification: "Strong Trend", marketOpportunity: "$340M by 2028", productConcept: "Lion's Mane nootropic coffee blend", packagingFormat: "Mushroom powder sachets (30-day supply)", launchTiming: "Q4 2025", opportunityBrief: "Functional mushrooms are moving from fringe to mainstream. Lion's Mane is the cognitive performance ingredient of 2025, driven by TikTok wellness creators.", signals: { velocity: 85, marketPotential: 75, scientificBacking: 74, consumerBuzz: 82, competition: 35 } },
    { name: "Magnesium Glycinate", score: 77, classification: "Strong Trend", marketOpportunity: "$290M by 2027", productConcept: "Evening magnesium + L-theanine sleep formula", packagingFormat: "Glass bottle capsules (60ct)", launchTiming: "Q1 2025", opportunityBrief: "Sleep anxiety is the #1 wellness concern for Indian urban millennials. The Indian market currently offers low-quality oxide formulations — a premium glycinate formula is a clear whitespace.", signals: { velocity: 83, marketPotential: 70, scientificBacking: 86, consumerBuzz: 79, competition: 65 } },
    { name: "Cycle Syncing", score: 72, classification: "Strong Trend", marketOpportunity: "$150M by 2027", productConcept: "Phase-specific women's supplement kit (4-pack)", packagingFormat: "Monthly subscription kit (4 labelled pouches)", launchTiming: "Q2 2025", opportunityBrief: "Cycle syncing is the fastest growing women's wellness concept on Instagram India. A 4-phase supplement kit would be a category-creating product with no Indian competitors.", signals: { velocity: 76, marketPotential: 58, scientificBacking: 57, consumerBuzz: 72, competition: 15 } },
    { name: "Creatine for Women", score: 70, classification: "Strong Trend", marketOpportunity: "$310M by 2027", productConcept: "Micronised creatine + collagen women's blend", packagingFormat: "Pastel canister (250g), scoop included", launchTiming: "Q1 2025", opportunityBrief: "Women creators on Instagram are now driving creatine adoption for strength, cognition, and skin. No Indian brand owns this positioning.", signals: { velocity: 70, marketPotential: 73, scientificBacking: 77, consumerBuzz: 71, competition: 40 } },
...
### ACTION 2 — Edit `index.tsx`

Go to `frontend/pages/index.tsx` → pencil icon → find this line:
```
